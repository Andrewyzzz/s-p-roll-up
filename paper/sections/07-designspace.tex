...
% consistency. Espresso and Across rows may need update pending Task 2.3
...
Espresso HotShot execution attestation$^\dagger$
  & (i) & Conditional
  & Operational
  & Attestation covers execution outcome only if both rollups are
    within same HotShot committee and proof covers both STFs. \\
\midrule
