...
\midrule
Astria       & $D_1$ & [PLACEHOLDER] & [PLACEHOLDER] & [PLACEHOLDER] \\
Espresso     & $D_1$ & [PLACEHOLDER] & [PLACEHOLDER] & [PLACEHOLDER] \\
Radius       & $D_1$ & [PLACEHOLDER] & [PLACEHOLDER] & [PLACEHOLDER] \\
Primev       & $D_2$ & [PLACEHOLDER] & [PLACEHOLDER] & [PLACEHOLDER] \\
Chainbound   & $D_2$ & [PLACEHOLDER] & [PLACEHOLDER] & [PLACEHOLDER] \\
\bottomrule
\end{tabular}
\end{table}
