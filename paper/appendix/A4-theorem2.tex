...
\centering
\small
\caption{Tail-index estimates across four chains. Hill $k=100$ primary;
  MLE (Clauset) as robustness check. Bootstrap 95\% CI (1,000 resamples).
  $\dagger$ Pilot estimate (N=200); replaced by full-dataset estimate upon completion.}
...
Base         & 2000 & [PLACEHOLDER] & [PLACEHOLDER] & [PLACEHOLDER] \\
Arbitrum     & 2000 & [PLACEHOLDER] & [PLACEHOLDER] & [PLACEHOLDER] \\
Polygon zkEVM & 2000 & [PLACEHOLDER] & [PLACEHOLDER] & [PLACEHOLDER] \\
\midrule
\textbf{Combined} & & \textbf{[PLACEHOLDER]} & \textbf{[PLACEHOLDER]} & \\
\bottomrule
\end{tabular}
\end{table}
